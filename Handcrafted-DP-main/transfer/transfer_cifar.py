# main function for training, use opacus but not mixing
...
def main(feature_path=path, batch_size=2048, mini_batch_size=256,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--noise_multiplier', type=float, default=2.4)
