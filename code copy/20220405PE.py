...
if use_norm:
    print("Use Norm", use_norm, "Group", small_batch, "CLIP NORM", clip_norm, "Use Mix", use_mix, gap_rate, "Noise", noise_scale, "Num of Epochs",
...
def main():
    ...
    lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[80], last_epoch=args.start_epoch - 1)
