...
#parser.add_argument('--resume', default='save_temp/4-75.th', type=str, metavar='PATH', help ='path to latest checkpoint (default: none)')
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch > 0 and epoch % args.save_every == 0:
            ...
            }, is_best, filename=os.path.join(args.save_dir, 'model4-65.th'))
