...
import numpy
import math
from opacus2 import PrivacyEngine
...
from opacus2.utils import module_modification
...
multi = 1.1
num_epoch =200
print("Imagenet L NORM:",clip_type,"Gap",gap_rate,"CLIP NORM",clip_norm,"Grouping",batch_select * virtual_bn,"Noise",multi,"Pruning",  prune_percentage, "Num of Epochs",  num_epoch, "Device", dev)
...
def main():
    ...
    privacy_engine.attach(optimizer, mask)
...
#def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(tqdm(train_loader)):
        ...
        optimizer.step()
        optimizer.zero_grad()
        prune.mask_initial(mask, model, initial)
